...
public class Breed{
    ...
    public List<Object> whippet;
    public List<Object> weimaraner;
    public List<String> waterdog;
    public List<Object> vizsla;
    public List<String> terrier;
    public List<Object> stbernard;
    public List<String> springer;
    public List<String> spaniel;
    public List<Object> shihtzu;
    public List<Object> shiba;
    public List<String> sheepdog;
    public List<String> setter;
    public List<String> schnauzer;
    public List<Object> schipperke;
    public List<Object> samoyed;
    public List<Object> saluki;
    public List<Object> rottweiler;
    public List<String> ridgeback;
    public List<String> retriever;
    public List<Object> redbone;
    public List<Object> pyrenees;
    public List<Object> puggle;
    public List<Object> pug;
    public List<String> poodle;
    public List<Object> pomeranian;
    public List<String> pointer;
    public List<Object> pitbull;
    public List<String> pinscher;
    public List<Object> pembroke;
    public List<Object> pekinese;
    public List<Object> dhole;
    public List<String> deerhound;
    public List<String> dane;
    public List<Object> dalmatian;
    public List<Object> dachshund;
    public List<Object> cotondetulear;
    public List<String> corgi;
    public List<Object> coonhound;
    public List<String> collie;
    public List<Object> cockapoo;
    public List<Object> clumber;
    public List<Object> chow;
    public List<Object> chihuahua;
    public List<String> cattledog;
    public List<Object> cairn;
    public List<String> bullterrier;
    public List<Object> beagle;
    public List<Object> basenji;
    public List<String> australian;
    public List<Object> appenzeller;
    public List<Object> akita;
    public List<Object> airedale;
    public List<Object> african;
    public List<Object> affenpinscher;
    public List<Object> bluetick;
    public List<Object> borzoi;
    public List<Object> bouvier;
    public List<Object> boxer;
    public List<Object> brabancon;
    public List<Object> briard;
    public List<String> buhund;
    public List<String> bulldog;
    public List<Object> dingo;
    public List<Object> doberman;
    public List<String> elkhound;
    public List<Object> entlebucher;
    public List<Object> eskimo;
    public List<String> finnish;
    public List<String> frise;
    public List<Object> germanshepherd;
    public List<String> greyhound;
    public List<Object> groenendael;
    public List<Object> havanese;
    public List<String> hound;
    public List<Object> husky;
    public List<Object> keeshond;
    public List<Object> kelpie;
    public List<Object> komondor;
    public List<Object> kuvasz;
    public List<Object> labradoodle;
    public List<Object> labrador;
    public List<Object> leonberg;
    public List<Object> lhasa;
    public List<Object> malamute;
    public List<Object> malinois;
    public List<Object> maltese;
    public List<String> mastiff;
    public List<Object> mexicanhairless;
    public List<Object> mix;
    public List<String> mountain;
    public List<Object> newfoundland;
    public List<Object> otterhound;
    public List<String> ovcharka;
    public List<Object> papillon;
    ...
    public List<Object> getLabradoodle() {
        return labradoodle;
    }

    public void setLabradoodle(List<Object> labradoodle) {
        this.labradoodle = labradoodle;
    }
    ...
    public List<String> getOvcharka() {
        return ovcharka;
    }

    public void setOvcharka(List<String> ovcharka) {
